        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    ...
                    <h1 class="white-text">Entrar em Contato</h1>
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        ...
                        <form role="form" method="post" action="{{route('contact')}}" enctype="multipart/form-data">
                            ...
                            <textarea class="input" name="message" placeholder="Digite sua Mensagem"></textarea>
                            <button class="main-button icon-button pull-right">Enviar Mensagem</button>
                        </form>
                    </div>
                </div>
                <!-- /contact form -->
