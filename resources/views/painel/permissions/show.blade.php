...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/painel/permissoes/{{$data->id}}">Visualizar</a></li>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            @if(isset($data->image))
                            <img src="{{URL::asset('/assets/uploads/permissoes/'.$data->image)}}" alt="$user->image" class="img-responsive img-rounded img-bordered">
                            @endif
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
                <!-- form start -->
                <form role="form" method="post" action="{{route('permissoes.destroy', $data->id)}}" >
                    {{ method_field('DELETE') }}
                    {{ csrf_field() }}
