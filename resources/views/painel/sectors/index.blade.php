...
@section('content')
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">
                <a href="{{route('sectors.create')}}" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> NOVA SETOR</a>
            </h3>
            <div class="box-tools">
                <form role="form" method="get" action="{{url('painel/sectors/pesquisar')}}" enctype="multipart/form-data">
                    {{--{{ csrf_field() }}--}}
            ...
            <table class="table table-hover">
                ...
                @forelse($datas as $data)
                    <tr>
                        ...
                        <td>
                            <a href='{{route('sectors.edit', $data->id)}}' class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a>
                            <a href="{{route('sectors.show', $data->id)}}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
                        </td>
                    </tr>
                    @empty
                    <div class="box-body">
