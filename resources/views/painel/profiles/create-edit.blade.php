...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/painel/perfis/create">Cadastrar</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                @if(isset($data))
                <form role="form" method="post" action="{{route('perfis.update', $data->id)}}" enctype="multipart/form-data">
                    {{ method_field('PUT') }}
                @else
                <form role="form" method="post" action="{{route('perfis.store')}}" enctype="multipart/form-data">
                @endif
                    {{ csrf_field() }}
                    <div class="box-body">
