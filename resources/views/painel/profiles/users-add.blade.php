...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/painel/perfis/{{$profile->id}}/usuarios/cadastrar">Cadastrar</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="post" action="{{route('profile.users.add', $profile->id)}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="box-body">
